...
public class TwoMethodsECA01 {
    ...
    /**
     * This is a method that receives the size and a fileName and will create
     * a pyramid and a file
     * @param size this is the size of the pyramid
     * @param fileName this is the name of the file that will be created
     * @throws IllegalArgumentException this is an exception when size is lessthan or equal to 0
     * @throws IOException this will throw an IO exception when unable to openfile
     */
    ...
    try {
        ...
        if (writer.checkError()) {
            throw new IOException("Error writing to output file.");
        }
   ...
   public static void pyramidInFile(int num, String fileName) throws IllegalArgumentException ,IOException
   { 
...
// Even number
    else if (num % 2 == 0)
    {
        ...
        {
            for(dash=lines-i-1;dash>0;dash--)
            {
                outputFile.print("-");
            }
